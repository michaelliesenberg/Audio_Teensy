...
static void endpoint0_setup(uint64_t setupdata)
{
	...
	switch (setup.wRequestAndType) {
	  ...
	  case 0x81A2: // GET_CUR (wValue=0, wIndex=interface, wLength=len)
		if (setup.wLength >= 3) {
            /*
#if AUDIO_SAMPLE_RATE_EXACT==44100
            endpoint0_buffer[0] = 44100 & 255;
            endpoint0_buffer[1] = 44100 >> 8;
#elif AUDIO_SAMPLE_RATE_EXACT==48000
            endpoint0_buffer[0] = 48000 & 255;
            endpoint0_buffer[1] = 48000 >> 8;
#elif AUDIO_SAMPLE_RATE_EXACT==96000
            endpoint0_buffer[0] = 96000 & 255;
            endpoint0_buffer[1] = 96000 >> 8;
#endif*/
